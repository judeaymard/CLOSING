                                ...
                                {messageAttachments
                                  ...
                                  .map((img) => (
                                    <button
                                      ...
                                      className="group relative rounded-xl overflow-hidden border border-slate-200/40 aspect-video bg-black/10 flex items-center justify-center cursor-pointer hover:opacity-95 transition-all"
                                    >
