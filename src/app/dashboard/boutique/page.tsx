...
export default function BoutiquePage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in-up">
      {/* HEADER */}
      <div>
        <h2 className="text-2xl font-black text-white tracking-tight">Boutique en ligne</h2>
      ...
      {/* MAIN CONTAINER */}
      <div className="bg-[#091b14] border border-emerald-900/60 rounded-3xl p-6 sm:p-8 space-y-6 max-w-4xl shadow-xl">
        <div>
          <h3 className="text-xl font-black text-white tracking-tight">Reliez votre boutique en ligne</h3>
          <p className="text-xs text-emerald-300/70 mt-1">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div
            ...
            className={`bg-emerald-950/30 border ${
              shopifyConnected ? "border-emerald-500 bg-emerald-950/50" : "border-emerald-500/60 hover:border-emerald-400"
          ...
          >
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-emerald-300/70 font-normal group-hover:text-white transition-colors">
                {shopifyConnected ? (
          ...
          <div
            ...
            className={`bg-emerald-950/30 border ${
              youcanConnected ? "border-emerald-500 bg-emerald-950/50" : "border-emerald-900/60 hover:border-emerald-400"
            } rounded-2xl p-8 flex flex-col items-center justify-center text-center space-y-3 cursor-pointer transition-all duration-200 group shadow-md`}
          >
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-xs text-emerald-300/70 font-normal group-hover:text-white transition-colors">
                {youcanConnected ? (
                  <span className="text-[#22c55e] font-bold flex items-center gap-1 justify-center">
                    <Check className="w-3.5 h-3.5" /> Boutique reliée
                  </span>
                ) : (
          ...
          {/* WOOCOMMERCE CARD */}
          <div className="bg-emerald-950/20 border border-emerald-900/40 rounded-2xl p-8 flex flex-col items-center justify-center text-center space-y-3 cursor-not-allowed opacity-90">
            <div className="w-12 h-12 rounded-xl bg-emerald-950 flex items-center justify-center text-emerald-400 font-extrabold text-xl">
              W
            </div>
      ...
      {/* ═══════════════════════════════════════════ */}
      <div className="bg-[#091b14] border border-emerald-900/60 rounded-3xl max-w-4xl shadow-xl overflow-hidden">
        <button
          onClick={() => setShowGuide(showGuide === "shopify" ? null : "shopify")}
          className="w-full p-5 flex items-center justify-between hover:bg-emerald-950/40 transition-colors"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] text-emerald-300/70">Étapes détaillées pour obtenir votre clé API</p>
            </div>
          </div>
          {showGuide === "shopify" ? (
        ...
        {showGuide === "shopify" && (
          <div className="px-5 pb-6 space-y-4 border-t border-emerald-900/60 pt-5">
            {/* Ce dont vous avez besoin */}
            <div className="bg-emerald-950/40 border border-emerald-900/60 rounded-xl p-4 space-y-2">
              <h5 className="text-xs font-bold text-[#22c55e] uppercase flex items-center gap-1.5">
                <ShieldCheck className="w-3.5 h-3.5" /> Ce dont vous avez besoin
              </h5>
              <ul className="text-xs text-emerald-200/80 space-y-1.5 list-none">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-xs text-emerald-200/80">
                    Allez dans <span className="font-bold text-white">Paramètres</span> (en bas à gauche) <ArrowRight className="w-3 h-3 inline text-emerald-400/60" /> <span className="font-bold text-white">Apps et canaux de vente</span> <ArrowRight className="w-3 h-3 inline text-emerald-400/60" /> <span className="font-bold text-white">Développer des apps</span>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-xs text-emerald-200/80">
                    Cliquez sur <span className="font-bold text-white">&quot;Créer une app&quot;</span>, nommez-la <code className="bg-slate-900 px-1.5 py-0.5 rounded text-[11px] text-[#22c55e]">eno_livraison</code>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-emerald-500/20 text-[#22c55e] text-xs font-bold flex items-center justify-center shrink-0">6</div>
                  <div className="text-xs text-emerald-200/80">
                    <span className="font-bold text-[#22c55e]">Collez votre URL et votre Token</span> dans le formulaire de connexion ENO LIVRAISON ci-dessus. C&apos;est terminé ! 🎉
                  </div>
                </div>
              </div>
            </div>
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-xs text-[#22c55e] font-bold hover:underline"
            >
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2.5">
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-xs text-emerald-200/80">
                    Allez dans <span className="font-bold text-white">Paramètres</span> <ArrowRight className="w-3 h-3 inline text-emerald-400/60" /> <span className="font-bold text-white">API &amp; Intégrations</span>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="text-xs text-emerald-200/80">
                    Cliquez <span className="font-bold text-white">&quot;Générer un nouveau token&quot;</span> et donnez-lui le nom <code className="bg-slate-900 px-1.5 py-0.5 rounded text-[11px] text-[#22c55e]">eno_livraison</code>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <div className="w-6 h-6 rounded-full bg-emerald-500/20 text-[#22c55e] text-xs font-bold flex items-center justify-center shrink-0">5</div>
                  <div className="text-xs text-emerald-200/80">
                    <span className="font-bold text-[#22c55e]">Collez votre URL et votre Token</span> dans le formulaire de connexion ENO LIVRAISON ci-dessus. C&apos;est terminé ! 🎉
                  </div>
                </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="text-left">
              ...
              <p className="text-[11px] text-emerald-300/70">Le parcours complet de votre commande</p>
            </div>
          </div>
          {showGuide === "flow" ? (
            <ChevronUp className="w-5 h-5 text-emerald-300/70" />
          ...
          <div className="px-5 pb-6 space-y-4 border-t border-emerald-900/60 pt-5">
            <div className="space-y-3">
              {[
                ...
                { step: "2", color: "bg-emerald-500/20 text-[#22c55e]", title: "Import automatique", desc: "La commande apparaît instantanément dans votre espace ENO LIVRAISON (onglet Commandes)." },
                { step: "3", color: "bg-amber-500/20 text-amber-400", title: "Closing téléphonique", desc: "Notre équipe de closeuses appelle le client sous 15 min pour confirmer la commande et l'adresse." },
                { step: "4", color: "bg-purple-500/20 text-purple-400", title: "Préparation & Livraison", desc: "Le colis est préparé depuis l'entrepôt ENO et livré au client. Le livreur encaisse en cash." },
                { step: "5", color: "bg-emerald-500/20 text-emerald-400", title: "Reversement Mobile Money", desc: "Le montant encaissé moins 2 800 F CFA (800 F Closing + 2 000 F Livraison) est viré sur votre MoMo." },
              ].map((item) => (
                <div key={item.step} className="flex gap-3 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-emerald-300/70 mt-0.5">{item.desc}</p>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-[#091b14] border border-emerald-900 w-full max-w-md rounded-3xl p-6 space-y-5 shadow-2xl relative">
            <div className="flex items-center justify-between border-b border-emerald-900/60 pb-3">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-emerald-300/70">Importation automatique des commandes COD</p>
                </div>
              </div>
              <button
            ...
            <form onSubmit={handleConnect} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-emerald-200/80 uppercase flex items-center gap-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-emerald-950 border border-emerald-800 rounded-xl text-sm text-white focus:outline-none focus:border-[#16a34a] font-mono"
                />
              </div>
              ...
              {/* Info box */}
              <div className="bg-emerald-950/40 border border-emerald-900/60 rounded-xl p-3 flex items-start gap-2">
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="px-5 py-2.5 rounded-xl bg-[#16a34a] hover:bg-[#15803d] text-white text-xs font-bold shadow-md flex items-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
